...
var grammar = {
    ...
    {"name": "top_level_statement", "symbols": ["array_definition"], "postprocess": id},
    {"name": "top_level_statement", "symbols": ["vector_definition"], "postprocess": id},
    {"name": "top_level_statement", "symbols": ["option_definition"], "postprocess": id},
    ...
    {"name": "struct_definition", "symbols": [{"literal":"struct"}, "__", "identifier", "_", "block_definition"], "postprocess":  
        function(data) {
            return {
                type: "struct",
                name: data[2].value,
    ...
    {"name": "rbracket", "symbols": [(lexer.has("rbracket") ? {type: "rbracket"} : rbracket)], "postprocess": convertTokenId},
    {"name": "labracket", "symbols": [(lexer.has("labracket") ? {type: "labracket"} : labracket)], "postprocess": convertTokenId},
    {"name": "rabracket", "symbols": [(lexer.has("rabracket") ? {type: "rabracket"} : rabracket)], "postprocess": convertTokenId},
    {"name": "lparan", "symbols": [(lexer.has("lparan") ? {type: "lparan"} : lparan)], "postprocess": convertTokenId},
    {"name": "rparan", "symbols": [(lexer.has("rparan") ? {type: "rparan"} : rparan)], "postprocess": convertTokenId},
    {"name": "lbrace", "symbols": [(lexer.has("lbrace") ? {type: "lbrace"} : lbrace)], "postprocess": convertTokenId},
    {"name": "rbrace", "symbols": [(lexer.has("rbrace") ? {type: "rbrace"} : rbrace)], "postprocess": convertTokenId},
    {"name": "comma", "symbols": [(lexer.has("comma") ? {type: "comma"} : comma)], "postprocess": convertTokenId},
    {"name": "colon", "symbols": [(lexer.has("colon") ? {type: "colon"} : colon)], "postprocess": convertTokenId},
    {"name": "semicolon", "symbols": [(lexer.has("semicolon") ? {type: "semicolon"} : semicolon)], "postprocess": convertTokenId},
